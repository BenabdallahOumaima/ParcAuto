...
namespace GestParcAuto.Mobile {
    ...
    public partial class GestParcAutoMobileApplication : MobileApplication {
        ...
        private GestParcAuto.Module.Mobile.GestParcAutoMobileModule module4;
        ...
        static GestParcAutoMobileApplication() {
        ...
        #endregion
        public GestParcAutoMobileApplication() {
            Tracing.Initialize();
        ...
        private void InitializeComponent() {
            ...
            this.module4 = new GestParcAuto.Module.Mobile.GestParcAutoMobileModule();
            ...
            //this.mapsMobileModule.GoogleApiKey = "Insert your key here";
            ...
            this.DatabaseVersionMismatch += new System.EventHandler<DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs>(this.GestParcAutoMobileApplication_DatabaseVersionMismatch);
        ...
        protected override void SetLogonParametersForUIBuilder(object logonParameters)
        {
            ...
            ((AuthenticationStandardLogonParameters)logonParameters).UserName = "Administrator";
